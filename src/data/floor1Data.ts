...
export const floor1Data: FloorData = {
  ...
  rooms: [
    // TOP ROW
    { id: "f1_reception",    name: "GymKhana",      center: [-20,   -5.25], connectedTo: ["f1_wp_corridor_l"] },
    { id: "f1_admin",        name: "G1",   center: [-10,   -5.25], connectedTo: ["f1_wp_mid"]        },
    { id: "f1_principal",    name: "G3",      center: [  1,   -5.25], connectedTo: ["f1_wp_mid"]        },
    { id: "f1_seminar",      name: "G5",   center: [ 14,   -5.25], connectedTo: ["f1_wp_corridor_r"] },
    // CORRIDOR LABEL
    ...
    { id: "f1_canteen",      name: "G2",        center: [ -8,    5.25], connectedTo: ["f1_wp_mid"]        },
    { id: "f1_store",        name: "G4",     center: [  4,    5.25], connectedTo: ["f1_wp_mid"]        },
    { id: "f1_exam",         name: "Gents Toilet",   center: [ 14,    5.25], connectedTo: ["f1_wp_corridor_r"] },
